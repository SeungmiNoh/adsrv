...
$(function(){
	...
	$(document).on("click", "tr[name=dayrpt]", function(e){		
		...
		var adsid = $("#frmRpt input[name=adsid]").val();
                ...
                <div class="tapBox3">
                		<nav class="tapMenu">
                            <ul>  
                                ...
                                <li><a href="#none"  name="rptMenu" alink="adsRpt" >애즈 리포트<span class="glyphicon glyphicon-menu-right"></span></a>
                                </li>
                                <li><a href="#name" class="active">광고물 리포트<span class="glyphicon glyphicon-menu-right"></span></a>
                                </li>                               
...
for(int k=0; k<adslist.size(); k++){
 ...
 <%} %>                 </select>                            
                 ...
                 <div class="boxtitle3" style="width:900px;">                   
                    <h1 class="title4"><span class="glyphicon glyphicon-align-justify"></span> 광고물 리포트</h1>
                </div>
