        ...
        <%@ include file="../common/header.jsp"  %>
             <section class="sectionBox">
                <div class="boxTitle">
                    ...
                    <div class="breadcrumbs"><span class="glyIcon"><img src="<%=web%>/img/navIcon.png" alt=""></span> 현재위치 : 리포트 > 사이트 > 사이트 리포트</div>
                    <!-- title End -->
                </div>
                <!-- ads add title Start -->
                <!-- search group Start -->
                ...
                <input type="hidden" name="a" value="<%=a %>">
                     <div class="form-inline">
                        ...
                        <div class="form-group formGroupPadd">
	                        ...
	                        <select id="sitetype" name="sitetype" class="form-control input-sm" style="width:120px">
                ...
                <br>
                <!-- list Table Start -->
                 <table class="listTable2 table-striped">
 				<colgroup>
				<col width="40">
				<col width="80"><!-- 사이트 구분 -->
				<col width="220"><!-- 섹션 -->
				<col width="90"><!-- Request -->
				<col width="90"><!-- IMP -->
				<col width="80"><!-- 잔여 -->
				<col width="50"><!-- Fill Rate -->
				<col width="80"><!-- 노출 -->
				<col width="80"><!-- 노출 -->
				<col width="80"><!-- 노출 -->
				<col width="70"><!-- 클릭 -->
...
for(int k=0; k<rptlist.size(); k++){
 ...
 %>                    
                      ...
                      <td><a href="rptmgr.do?a=siteRptDaily&siteid=<%=rpt.getSiteid()%>"/><%=rpt.getSitename() %></a></td>
