        ...
        <%@ include file="../common/header.jsp"  %>
             <section class="sectionBox">
                <div class="boxTitle">
                    ...
                    <div class="breadcrumbs"><span class="glyIcon"><img src="<%=web%>/img/navIcon.png" alt=""></span> 현재위치 : 리포트 > 위치 리포트</div>
                    <!-- title End -->
                </div>
                <!-- campaign view Start -->
                <!-------------------------------------------------- 공통  ---------------------------------------------->
 				<%@ include file="./slot_rpt.jsp" %>
              <!-------------------------------------------------- 공통  ---------------------------------------------->
                <br>
                <!-- list Table Start -->
...
%>                    
                        ...
                        <tr>
                      <td class="textCenter"><span class="<%=wkstyle%>"><%=DateUtil.getYMD(rpt.getRptday()) %>   (<%=wkname%>)</span></td>
