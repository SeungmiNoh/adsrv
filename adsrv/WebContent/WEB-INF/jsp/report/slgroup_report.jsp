        ...
        <%@ include file="../common/header.jsp"  %>
             <section class="sectionBox">
                <div class="boxTitle">
                    ...
                    <div class="breadcrumbs"><span class="glyIcon"><img src="<%=web%>/img/navIcon.png" alt=""></span> 현재위치 : 리포트 > 사이트 > 위치그룹 리포트</div>
                    <!-- title End -->
                </div>
                <!-- ads add title Start -->
                <!-- search group Start -->
...
for(int k=0; k<rptlist.size(); k++){
 ...
 %>                    
                        ...
                        <tr>
                      <td><%=(k+1) %></td>
                      <td><a href="rptmgr.do?a=slgroupRptDaily&groupid=<%=rpt.getGroupid()%>"/><%=rpt.getGroupname() %></a></td>
                      <td class="textCenter"><%=rpt.getWidth()%> * <%=rpt.getHeight() %></td>                    
