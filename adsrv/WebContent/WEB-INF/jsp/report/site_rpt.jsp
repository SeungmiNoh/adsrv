    ...
    pageEncoding="UTF-8"%>				
           <table class="viewTable" style="width:500px">
                ...
                <div class="tapBox3">
                    <nav class="tapMenu">
                        <ul>
                            <li><a href="#none" a="Daily" class="menuLink <%=a.equals("siteRptDaily")?"active":""%>">일자별 리포트</a>
                            </li>
                            <li><a href="#none" a="Timely" class="menuLink <%=a.equals("siteRptTimely")?"active":""%>">시간별 리포트</a>
                            </li>
                            <li><a href="#none" a="Country" class="menuLink <%=a.equals("siteRptCountry")?"active":""%>">국가 리포트</a>
                            </li>
                        </ul>
                    </nav>
                    <!-- ads list Start -->
...
$(function(){
	...
	$(document).on("click", ".menuLink", function(e){
	  	...
	  	$("#frmRpt input[name=a]").val("siteRpt"+$(this).attr("a"));
	  	$("#frmRpt").submit();
	});
});
</script>               