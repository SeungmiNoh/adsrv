        ...
        <%@ include file="../common/header.jsp"  %>
             <section class="sectionBox">
                <div class="boxTitle">
                    ...
                    <div class="breadcrumbs"><span class="glyIcon"><img src="<%=web%>/img/navIcon.png" alt=""></span> 현재위치 : 리포트 > 캠페인 목록</div>
                    <!-- title End -->
                </div>
                <!-- search group Start -->
                <form id="frmList" name="frmList" method="get" action="rptmgr.do?a=cpRpt">
				<input type="hidden" name="a" value="cpRpt"/>
...
for(int k=0; k<cplist.size(); k++){
 ...
 %>                    
						<tr>
                            ...
                            <a href="rptmgr.do?a=summary&cpid=<%=cp.getCpid()%>" class="<%=cp.getText()%>"><%=cp.getCpname() %><%=cp.getIstarget().equals("Y")?"<span class='txtRed' style='font-size:8pt;margin:4px'>targeting</span>":""%></a>
                            </td>
