    ...
    pageEncoding="UTF-8"%>				
           <table class="viewTable" style="width:900px">
                    ...
                    <tr>
                        ...
                        <th>위치</th>
                        <td><%=slot.getPrtag()%>/<%=slot.getSitetag()%>/<%=slot.getSectag()%>/<%=slot.getSlottag() %></td>
                    </tr>               </table>
                <br>
                <br>
                <!-- view Table End -->
                ...
                <div class="tapBox3">
                    <nav class="tapMenu">
                        <ul>
                            <li><a href="#none" a="slotRptDaily" class="menuLink <%=a.equals("slotRptDaily")?"active":""%>">일자별 리포트</a>
                            </li>
                            <li><a href="#none" a="slotRptTime" class="menuLink <%=a.equals("slotRptTime")?"active":""%>">시간별 리포트</a>
                            </li>
                            <li><a href="#none" a="slotRptCountry" class="menuLink <%=a.equals("slotRptCountry")?"active":""%>">국가 리포트</a>
                            </li>
                        </ul>
                    </nav>
                    <!-- ads list Start -->
