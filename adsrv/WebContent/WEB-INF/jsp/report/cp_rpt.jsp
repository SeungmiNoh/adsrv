           ...
           <table class="viewTable" style="width:900px">
               ...
               <form id="frmRpt" action="rptmgr.do" method="get">
                ...
                <div class="tapBox3">
                		<nav class="tapMenu">
                            <ul>  
                                <li><a href="#none" a="summary" name="menuLink" class="<%=a.equals("summary")?"active":""%>">요약리포트<span class="glyphicon glyphicon-menu-right"></span></a>
                                </li>
                                <li><a href="#none" a="adsRpt" name="menuLink" class="<%=a.equals("adsRpt")?"active":""%>">애즈 리포트<span class="glyphicon glyphicon-menu-right"></span></a>
                                </li>
                                <li><a href="#none" a="crRpt" name="menuLink" class="<%=a.equals("crRpt")?"active":""%>">광고물 리포트<span class="glyphicon glyphicon-menu-right"></span></a>
                                </li>                               
                                <li><a href="#none" a="timeRpt" name="menuLink" class="<%=a.equals("timeRpt")?"active":""%>">시간 리포트<span class="glyphicon glyphicon-menu-right"></span></a>
                                </li>
                                <li><a href="#none" a="countryRpt" name="menuLink" class="<%=a.equals("countryRpt")?"active":""%>">국가 리포트<span class="glyphicon glyphicon-menu-right"></span></a>
                                </li>
                            </ul>
                        </nav>
                 </div>
