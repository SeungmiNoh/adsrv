...
try
{
	...
	{	
		...
		category = valueinfo.getCategory(); 
...
<script>
  $(document).ready(function() {
		...
		for(var k=0; k<code_data.length; k++) {
			...
			console.log("/" + code_data[k].tname + "( "+code_data[k].tvalue+") num = "+ num + "/" + (num & code_data[k].tvalue));			
			if( (num & code_data[k].tvalue) > 0) {
				htmlstr += ' selected';	
			}
