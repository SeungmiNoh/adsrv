 ...
 %>                    
                        ...
                        <tr>
                            ...
                            <td class="form-inline">
                                <input type="text" id="start<%=(k+1) %>" datagrp="<%=(k+1) %>" name="startdate" value="<%=DateUtil.getYMD(cr.getStartdate()) %>" class="start form-control input-xs datepicker datePickStart" style="width:70px">                                
                            ...
                            <td class="form-inline">
                            	<input type="text" id="end<%=(k+1) %>" datagrp="<%=(k+1) %>" name="enddate" value="<%=DateUtil.getYMD(cr.getEnddate()) %>" class="end form-control input-xs datepicker datePickEnd" style="width:70px">
