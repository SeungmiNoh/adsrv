...
$(function(){
	...
	$("a[name=tmpView]").click(function(e){	
	
		var tmpid = $(this).attr("tmpid");
		$('#myModal').modal();
		$(".modal-title").text("템플릿 수정");
		$(".modify").css("display","");
		$("#tmpid").val(tmpid);
             ...
             <section class="sectionBox">
                ...
                <!-- saveBtn Start -->
  				<div class="outsaveBtn1">
                    <a class="btn btn-danger" href="#"  data-target="#myModal" id="btnPopup">템플릿등록</a>
                </div>                  
                <!-- saveBtn End -->
                <br>
                <!-- list Table Start -->
...
for(int k=0; k<tmplist.size(); k++){
 ...
 %>                    
                        ...
                        <tr>
                            <td><%=skip+(k+1) %></td>
                            <td class="textLeft"><a href="#none" name="tmpView" tmpid="<%=String.valueOf(tmp.get("tmpid"))%>"><%=tmp.get("tmpname") %></a></td>                           
                            <td class="textLeft"><%=tmp.get("memo") %></td>
                            <td><%=String.valueOf(tmp.get("updatedate")) %></td>
